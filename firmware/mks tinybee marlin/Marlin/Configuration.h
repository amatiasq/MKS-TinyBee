...
#define X_MIN_POS 0  // CESAR - esto debe ser un numero negativo
#define Y_MIN_POS 0  // creo que representa cuanto hay que mover el extrusor hacia atrás para que quede en el punto 0
#define Z_MIN_POS 0
